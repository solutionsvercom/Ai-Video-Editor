...
export default function Editor() {
  ...
  const handleExport = () => {
    router.push(createPageUrl(`Export?id=${projectId}`));
  };
      ...
      <div className="glass-effect border-b border-white/10 px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <button onClick={() => router.push(createPageUrl('Projects'))} className="p-2 hover:bg-white/10 rounded-lg transition-colors">
